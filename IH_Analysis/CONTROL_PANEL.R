...
###########               Control Pannel               ###########
##################################################################
setwd("~/Desktop/Interactive Health/IH_Analysis/")
...
company_name <- "INTERACTIVE HEALTH" # All caps, used to label tableau reports
directory <- "~/Desktop/Interactive Health/IH_Analysis/"
...
cd ~/Desktop/'Interactive Health'/'IH_Analysis'/
aws s3 cp s3://interactivehealth-civis/project/'NEW Interactive Health Full Member Census ao 03072017.csv' Data/Raw/raw_census.csv
aws s3 cp s3://interactivehealth-civis/project/'NEW Interactive Health Demo and Health.csv' Data/Raw/raw_phs.csv
aws s3 cp s3://interactivehealth-civis/project/'NEW Interactive Health Civis Medical Data 01012015-12312016.csv' Data/Raw/raw_claims.csv
aws s3 cp s3://interactivehealth-civis/project/'NEW Claim Detail - Interactive Health Solutions 1-1-15 - 12-31-16.csv' Data/Raw/raw_rx.csv
"
