...
###########               Control Pannel               ###########
##################################################################
setwd("~/Desktop/Interactive Health/IH_SE_Analysis/")
...
company_name <- "SCHNEIDER ELECTRIC" # All caps, used to label tableau reports
directory <- "~/Desktop/Interactive Health/IH_SE_Analysis/"
stop_loss_amount <- 10000
analysis_date <- mdy('01/01/2017')
analysis_start <- mdy('01/01/2014')
...
cd ~/Desktop/'Interactive Health'/'IH_SE_Analysis'/
aws s3 ls s3://interactivehealth-civis/project/
aws s3 cp s3://interactivehealth-civis/project/'NEW dSCHNEIDERELECTRICinteractivehlthClaim.txt' Data/Raw/raw_claims.txt
aws s3 cp s3://interactivehealth-civis/project/'IHData_Schneider_Electric_Biometric_Full.xlsx' Data/Raw/raw_phs.xlsx
aws s3 cp s3://interactivehealth-civis/project/'IHData_Schneider_Electric_Biometric_New_13.csv' Data/Raw/raw_phs_13.csv
aws s3 cp s3://interactivehealth-civis/project/'Schneider_2014_Claims_Detail_BHAA_claim_detail.csv' Data/Raw/rx_2014.csv
aws s3 cp s3://interactivehealth-civis/project/'Schneider_2015_Claims_Detail_BHAA_claims_detail.csv' Data/Raw/rx_2015.csv
aws s3 cp s3://interactivehealth-civis/project/'Schneider_2016_Claims_Detail_BHAA_claims_detail.csv' Data/Raw/rx_2016.csv
aws s3 cp s3://interactivehealth-civis/project/'NEW dSCHNEIDERELECTRICinteractivehlthEligibility.txt' Data/Raw/raw_census_14_15.txt
aws s3 cp s3://interactivehealth-civis/project/'SCHNEIDERELECTRICinteractivehlthEligibility.txt' Data/Raw/raw_census_16.txt
"
